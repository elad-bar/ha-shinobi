...
PLUG_SENSOR_TYPE = {
    TRIGGER_PLUG_TENSORFLOW: SENSOR_TYPE_MOTION,
    TRIGGER_PLUG_YOLO: SENSOR_TYPE_MOTION,
    TRIGGER_PLUG_DEEPSTACK_OBJECT: SENSOR_TYPE_MOTION,
    TRIGGER_PLUG_DB: SENSOR_TYPE_SOUND,
    TRIGGER_PLUG_DEEPSTACK_FACE: EVENT_FACE_RECOGNITION
}
